...
public class CatalogoAziendaController extends Homepage {
    ...
    public CatalogoAziendaController(Stage stage, CatalogoAzControl catalogoAzControl, List<Farmaco> catalogList) {
        super(stage);
        this.stage = stage;
